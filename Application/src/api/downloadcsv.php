<?php
    ...
    $crimeType = json_decode($_POST['crimeType']);
    $neighborhood = json_decode($_POST['neighborhood']);
    $month = $_POST['month'];
    $year = $_POST['year'];
    ...
    $neighborhoodString .= ")";
    print $neighborhoodString;

    $getCrime = "SELECT `DATE`, STREET, crime_type, community_name, LOCATION_DESCRIPTION, ARREST, DOMESTIC, LATITUDE, LONGITUDE
    ...
    $filename = "Chicago_Crime_Selection_" . $month . "_" . $year;
    ...
    $headers = array("Date", "Street Adress", "Crime Type", "Community", "Location Type", "Arrested?", "Domestic?", "Latitude", "Longitude");
    fputcsv($f, $headers);
